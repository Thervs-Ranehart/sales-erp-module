(function () {
    ...
    function readInitialDataFromRoot(rootEl) {
        ...
        try {
            ...
            console.warn('Sales by region chart: invalid data-chart-initial-data JSON.', e);
            return null;
        }
    }
    ...
    function createChartForRoot(rootEl) {
        ...
        const chartId =
            ...
            'salesByRegionHorizontalBarChart';
        ...
        if (!built) {
            console.warn(
                'Sales by region horizontal bar chart data missing or malformed.'
            );
            return;
        }
