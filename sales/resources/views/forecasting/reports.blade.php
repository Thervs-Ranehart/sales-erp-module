...
@section('content')
    ...
    @php($kpis = [
        ...
        ['label' => 'Full-Year Growth', 'value' => ($reportKpis['salesGrowth'] >= 0 ? '+' : '').number_format($reportKpis['salesGrowth'], 1).'%', 'icon' => 'bar-chart-line', 'tone' => $reportKpis['salesGrowth'] >= 0 ? 'text-success' : 'text-danger', 'accent' => 'rgba(16, 185, 129, 0.13)'],
