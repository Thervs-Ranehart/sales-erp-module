...
$mainItems = [  
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'Support Tickets', 'route' => 'support.index', 'icon' => 'ticket'],
            ['label' => 'Warranty Records', 'route' => 'support.index', 'icon' => 'clipboard2-check'],
            ['label' => 'Warranty Claims', 'route' => 'support.index', 'icon' => 'file-earmark-text'],
            ['label' => 'Service Contracts', 'route' => 'support.index', 'icon' => 'file-earmark'],
            ['label' => 'Service Requests', 'route' => 'support.index', 'icon' => 'list-check'],
            ['label' => 'Resolution Tracking', 'route' => 'support.index', 'icon' => 'diagram-3'],
            ['label' => 'Customer Satisfaction', 'route' => 'support.index', 'icon' => 'star'],
        ],
    ],
    [
